...
def process_mobile_payment(call):
    try:
        ...
        if match:
            ...
            lien_paiement = generate_cinetpay_payment_link(montant_livraison, id_recu, call.from_user.id)
            ...
            if lien_paiement:
                ...
                verify_course_payment_periodically(call.from_user.id, montant_livraison)
            else:
...
def get_spot_video():
    try:
        ...
        base_path = r"~/NGD/Pictures"  # Remplacez par le chemin correct
    except (Exception, mysql.connector.Error) as error:
...
def get_product_images(product_name):
    try:
        ...
        base_path = r"~/NGD/Pictures/"  # Chemin de base de votre serveur local
    except (Exception, mysql.connector.Error) as error:
