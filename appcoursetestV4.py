...
config.read('C:/Users/HP/Documents/NGD/config.ini')
...
QR_CODE_DIR = "C:/Users/HP/Documents/NGD/V2/qr_codes"
...
def get_spot_video():
    try:
        ...
        base_path = r"C:/Users/HP/Pictures/"  # Remplacez par le chemin correct
    except (Exception, mysql.connector.Error) as error:
...
def get_product_images(product_name):
    try:
        ...
        base_path = r"C:/Users/Public/Pictures/"  # Chemin de base de votre serveur local
    except (Exception, mysql.connector.Error) as error:
